...
ZORRO_BUILD_EXPRESSION(ETrainFlag* , TrainMode, &g->nOptimize)
ZORRO_BUILD_EXPRESSION(ETradeFlag* , TradeMode, &g->nTradeMode)
ZORRO_BUILD_VARIABLE  (EPlotMode   , PlotMode ,  g->nPlotMode)
ZORRO_BUILD_EXPRESSION(EPlotMode*  , ChartMode, &g->nPlotMode)
