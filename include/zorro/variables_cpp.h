...
ZORRO_BUILD_VARIABLE  (zcolor , ColorDn    , g->dwColorDn)
ZORRO_BUILD_VARIABLE  (zcolor , ColorUp    , g->dwColorUp)
ZORRO_BUILD_VARIABLE  (zcolor , ColorCandle, g->dwColorCandle)
ZORRO_BUILD_VARIABLE  (zcolor , ColorEquity, g->dwColorEquity)
ZORRO_BUILD_VARIABLE  (zcolor , ColorDD    , g->dwColorDD)
ZORRO_BUILD_VARIABLE  (zcolor , ColorWin   , g->dwColorWin)
ZORRO_BUILD_VARIABLE  (zcolor , ColorLoss  , g->dwColorLoss)
ZORRO_BUILD_EXPRESSION(zcolor*, ColorBars  , g->dwColorBars)
ZORRO_BUILD_EXPRESSION(zcolor*, ColorPanel , g->dwColorPanel)
...
ZORRO_BUILD_VARIABLE(int , Hedge       , g->nHedge)
ZORRO_BUILD_VARIABLE(int , Optimize    , g->nOptimize)
ZORRO_BUILD_VARIABLE(int , Fill        , g->nFill)
ZORRO_BUILD_VARIABLE(DATE, Now         , g->tNow)

ZORRO_BUILD_EXPRESSION(int*, TrainMode , &g->nOptimize)
ZORRO_BUILD_EXPRESSION(int*, TradeMode , &g->nTradeMode)
ZORRO_BUILD_VARIABLE  (int , PlotMode  ,  g->nPlotMode)
ZORRO_BUILD_EXPRESSION(int*, ChartMode , &g->nPlotMode)
...
ZORRO_BUILD_VARIABLE  (int, BarZone        , g->nBarZone)
...
ZORRO_BUILD_EXPRESSION(void*, Loop1        , g->pLoopPar[0])
ZORRO_BUILD_EXPRESSION(void*, Loop2        , g->pLoopPar[1])
...
ZORRO_BUILD_VARIABLE  (int  , Detrend      , g->nDetrend)
ZORRO_BUILD_VARIABLE  (int  , Weekend      , g->nWeekend)
...
ZORRO_BUILD_VARIABLE  (int  , Verbose   , g->nVerbose)
ZORRO_BUILD_VARIABLE  (DWORD, SaveMode  , g->nSaveMode)
...
ZORRO_BUILD_EXPRESSION(string*, Assets     , g->pAssets)
ZORRO_BUILD_EXPRESSION(ASSET* , ThisAsset  , g->asset)
ZORRO_BUILD_EXPRESSION(char*  , Asset      , g->asset->sName)
...
ZORRO_BUILD_EXPRESSION(var*   , AssetVar   , g->asset->Skill)
ZORRO_BUILD_EXPRESSION(string , AssetStr   , reinterpret_cast<string>(g->asset->Skill))
...
ZORRO_BUILD_EXPRESSION(char*  , Symbol     , g->asset->sSymbol)
...
ZORRO_BUILD_EXPRESSION(float*, Results        , g->pResults)
ZORRO_BUILD_EXPRESSION(var*  , ResultsDaily   , g->pCurve)
ZORRO_BUILD_EXPRESSION(var*  , DatesDaily     , g->pTime)
ZORRO_BUILD_EXPRESSION(BAR*  , Bars           , g->bars)
...
ZORRO_BUILD_EXPRESSION(TRADE* , ThisTrade       , g->tr)
...
ZORRO_BUILD_VARIABLE  (int    , TradeContract   , g->tr->nContract)
ZORRO_BUILD_VARIABLE  (float  , TradeStrike     , g->tr->fStrike)
ZORRO_BUILD_VARIABLE  (float  , TradeUnderlying , g->tr->fUnl)
ZORRO_BUILD_EXPRESSION(var*   , TradeVar        , g->tr->Skill)
ZORRO_BUILD_EXPRESSION(float* , TradeParameter  , g->tr->fArg)
ZORRO_BUILD_EXPRESSION(int    , TradeDir        , TradeIsShort ? -1 : 1)
ZORRO_BUILD_EXPRESSION(STATUS*, TradeStatus     , g->tr->status)
ZORRO_BUILD_EXPRESSION(char*  , TradeAlgo       , g->tr->status->sAlgo)
ZORRO_BUILD_EXPRESSION(char*  , TradeAsset      , g->tr->status->asset->sName)
...
ZORRO_BUILD_EXPRESSION(CONTRACT*, Contracts   , g->asset->pContracts)
...
ZORRO_BUILD_EXPRESSION(CONTRACT*, ThisContract, g->contract)
