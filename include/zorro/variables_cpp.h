...
ZORRO_BUILD_VARIABLE  (TColor , ColorDn    , g->dwColorDn)
ZORRO_BUILD_VARIABLE  (TColor , ColorUp    , g->dwColorUp)
ZORRO_BUILD_VARIABLE  (TColor , ColorCandle, g->dwColorCandle)
ZORRO_BUILD_VARIABLE  (TColor , ColorEquity, g->dwColorEquity)
ZORRO_BUILD_VARIABLE  (TColor , ColorDD    , g->dwColorDD)
ZORRO_BUILD_VARIABLE  (TColor , ColorWin   , g->dwColorWin)
ZORRO_BUILD_VARIABLE  (TColor , ColorLoss  , g->dwColorLoss)
ZORRO_BUILD_EXPRESSION(TColor*, ColorBars  , g->dwColorBars)
ZORRO_BUILD_EXPRESSION(TColor*, ColorPanel , g->dwColorPanel)
