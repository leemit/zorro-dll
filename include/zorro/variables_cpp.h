...
ZORRO_BUILD_VARIABLE  (DWORD , ColorDn    , g->dwColorDn)
ZORRO_BUILD_VARIABLE  (DWORD , ColorUp    , g->dwColorUp)
ZORRO_BUILD_VARIABLE  (DWORD , ColorCandle, g->dwColorCandle)
ZORRO_BUILD_VARIABLE  (DWORD , ColorEquity, g->dwColorEquity)
ZORRO_BUILD_VARIABLE  (DWORD , ColorDD    , g->dwColorDD)
ZORRO_BUILD_VARIABLE  (DWORD , ColorWin   , g->dwColorWin)
ZORRO_BUILD_VARIABLE  (DWORD , ColorLoss  , g->dwColorLoss)
ZORRO_BUILD_EXPRESSION(DWORD*, ColorBars  , g->dwColorBars)
ZORRO_BUILD_EXPRESSION(DWORD*, ColorPanel , g->dwColorPanel)
