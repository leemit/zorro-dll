...
// system functions
C R(int)  F(print)    A((int to,const char* format VA))               D({ return DF(print)   (to, format); });
C R(int)  F(msg)      A((const char* format VA))                      D({ return DF(msg)     (format); });
C R(HWND) F(window)   A((const char* title))                          D({ return DF(window)  (title); });
C R(void) F(keys)     A((const char* format VA))                      D({ return DF(keys)    (format); });
...
C R(void) F(sound)    A((const char* filename))                       D({        DF(sound)   (filename); });

C R(int)   F(login)   A((int mode))                                   D({ return DF(login)        (mode); });
C R(int)   F(exec)    A((const char* name,const char* args,int mode)) D({ return DF(exec)         (name,args,mode); });
...
C R(var) F(wdatef)        A((const char* format,const char* dateTime)) D({ return DF(wdatef)       (format,dateTime); });
...
C R(string) F(strf)     A((const char* format VA))                       D({ return DF(strf)    (format); });
C R(string) F(strx)     A((char* str,const char* orig,const char* repl)) D({ return DF(strx)    (str,orig,repl); });
C R(string) F(strxc)    A((char* str,char orig,char repl))               D({ return DF(strxc)   (str,orig,repl); });
...
C R(short*) F(strw)     A((const char* in))                              D({ return DF(strw)    (in); });
...
C R(long)   F1(file_append) A((string name,void* content,long size))  D({ return DF1(file_append)(name,content,size); });
...
// dataset
C R(int)    F(dataDownload) A((const char* code,int mode,int period))                    D({ return DF(dataDownload)(code,mode,period); });
C R(int)    F0(dataParse)   A((int handle,const char* format,const char* fileName))      D({ return DF0(dataParse)  (handle,format,fileName); });
C R(void)   F(dataSave)     A((int handle,string fileName,int start,int num VA))         D({        DF(dataSave)    (handle,fileName,start,num); });
C R(void)   F(dataSaveCSV)  A((int handle,char* format,char* name,int start,int num VA)) D({        DF(dataSaveCSV) (handle,format,name,start,num); });
...
C R(char*) F0(loop)        A((void* p0  I(0),void* p1  I(0),void* p2  I(0),void* p3  I(0),void* p4  I(0),void* p5  I(0),void* p6  I(0),void* p7  I(0),void* p8  I(0),void* p9  I(0),void* p10 I(0),
	                          void* p11 I(0),void* p12 I(0),void* p13 I(0),void* p14 I(0),void* p15 I(0),void* p16 I(0),void* p17 I(0),void* p18 I(0),void* p19 I(0),
                              void* p20 I(0),void* p21 I(0),void* p22 I(0),void* p23 I(0),void* p24 I(0),void* p25 I(0),void* p26 I(0),void* p27 I(0),void* p28 I(0),void* p29 I(0),void* p30 I(0),
	                          void* p31 I(0),void* p32 I(0),void* p33 I(0),void* p34 I(0),void* p35 I(0),void* p36 I(0),void* p37 I(0),void* p38 I(0),void* p39 I(0) VA))
...
C R(var)   F1(adviseLong)  A((int method,var objective,var* signals,long numSignals)) D({ return DF1(adviseLong)(method,objective,signals,numSignals); });
...
// series
C R(var*) F0(series)   A((var value I(0),int length I(0) VA))      D({ return DF0(series)  (value,length); });
C R(void) F(shift)     A((var* data,var value,int length))         D({        DF(shift)    (data,value,length); });
C R(var*) F(rev)       A((var* data,int length VA))                D({ return DF(rev)      (data,length); });
C R(void) F(sortData)  A((var* data,int length))                   D({        DF(sortData) (data,length); });
C R(int*) F(sortIdx)   A((var* data,int length))                   D({ return DF(sortIdx)  (data,length); });
C R(var)  F(randomize) A((int method,var *out,var *in,int length)) D({ return DF(randomize)(method,out,in,length); });
...
// curves
C R(BOOL) F(peak)        A((vars a))        D({ return DF(peak)       (a); });
C R(BOOL) F(valley)      A((vars a))        D({ return DF(valley)     (a); });
C R(BOOL) F0(crossOver)  A((vars a,vars b)) D({ return DF0(crossOver) (a,b); });
C R(BOOL) F1(crossOver)  A((vars a,var b))  D({ return DF1(crossOver) (a,b); });
C R(BOOL) F0(crossUnder) A((vars a,vars b)) D({ return DF0(crossUnder)(a,b); });
C R(BOOL) F1(crossUnder) A((vars a,var b))  D({ return DF1(crossUnder)(a,b); });
C R(BOOL) F(rising)      A((vars a))        D({ return DF(rising)     (a); });
C R(BOOL) F(falling)     A((vars a))        D({ return DF(falling)    (a); });
C R(var)  F(concave)     A((vars a))        D({ return DF(concave)    (a); });
...
C R(var)  F(peakF)        A((var* a))            D({ return DF(peakF)       (a); });
C R(var)  F(valleyF)      A((var* a))            D({ return DF(valleyF)     (a); });
C R(var)  F(risingF)      A((var* a))            D({ return DF(risingF)     (a); });
C R(var)  F(fallingF)     A((var* a))            D({ return DF(fallingF)    (a); });
C R(var)  F0(crossOverF)  A((var* a,var* b))     D({ return DF0(crossOverF) (a,b); });
C R(var)  F1(crossOverF)  A((var* a,var b))      D({ return DF1(crossOverF) (a,b); });
C R(var)  F0(crossUnderF) A((var* a,var* b))     D({ return DF0(crossUnderF)(a,b); });
C R(var)  F1(crossUnderF) A((var* a,var b))      D({ return DF1(crossUnderF)(a,b); });
...
// analysis
C R(int) F(predict)           A((int type,vars data,int timePeriod,var threshold))      D({ return DF(predict)         (type,data,timePeriod,threshold); });
C R(var) F(polyfit)           A((var* a,vars data,int timePeriod,int n,var weight))     D({ return DF(polyfit)         (a,data,timePeriod,n,weight); });
C R(var) F(polynom)           A((var* a,int n))                                         D({ return DF(polynom)         (a,n); });
C R(var) F(frechet)           A((vars data,int timePeriod,var factor,var* pattern))     D({ return DF(frechet)         (data,timePeriod,factor,pattern); });
C R(var) F(verify)            A((vars data,int length,var depth,int width,int horizon)) D({ return DF(verify)          (data,length,depth,width,horizon); });
C R(var) F0(markowitz)        A((var* covMatrix,var* means,int n,var* caps))            D({ return DF0(markowitz)      (covMatrix,means,n,caps); });
C R(var) F1(markowitz)        A((var* covMatrix,var* means,int n,var cap))              D({ return DF1(markowitz)      (covMatrix,means,n,cap); });
C R(var) F(markowitzReturn)   A((var* weights,var vVariance))                           D({ return DF(markowitzReturn) (weights,vVariance); });
C R(var) F(markowitzVariance) A((var* weights,var vReturn))                             D({ return DF(markowitzVariance)(weights,vReturn); });

// filters
C R(var) F(Gauss)          A((vars data,int length))                       D({ return DF(Gauss)         (data,length); });
C R(var) F(Median)         A((vars data,int length))                       D({ return DF(Median)        (data,length); });
C R(var) F(Percentile)     A((vars data,int length,var percent))           D({ return DF(Percentile)    (data,length,percent); });
C R(var) F(PercentRank)    A((vars data,int length,var value))             D({ return DF(PercentRank)   (data,length,value); });
C R(var) F(DominantPeriod) A((vars data,int period))                       D({ return DF(DominantPeriod)(data,period); });
C R(var) F(DominantPhase)  A((vars data,int period))                       D({ return DF(DominantPhase) (data,period); });
C R(var) F(HighPass1)      A((vars data,int cutoff))                       D({ return DF(HighPass1)     (data,cutoff); });
C R(var) F(HighPass)       A((vars data,int cutoff))                       D({ return DF(HighPass)      (data,cutoff); });
C R(var) F0(LowPass)       A((vars data,int cutoff))                       D({ return DF0(LowPass)      (data,cutoff); });
C R(var) F1(LowPass)       A((vars buffer,var val,int period))             D({ return DF1(LowPass)      (buffer,val,period); });
C R(var) F(BandPass)       A((vars data,int period,var delta))             D({ return DF(BandPass)      (data,period,delta); });
C R(var) F0(Spectrum)       A((vars data,int timePeriod,int samplePeriod)) D({ return DF0(Spectrum)     (data,timePeriod,samplePeriod); });
C R(var) F1(Spectrum)      A((vars data,int timePeriod))                   D({ return DF1(Spectrum)     (data,timePeriod); });

// TA-LIB
C R(var) F(ADX)         A((int timePeriod))                                           D({ return DF(ADX)        (timePeriod); });
C R(var) F(ADXR)        A((int timePeriod))                                           D({ return DF(ADXR)       (timePeriod); });
C R(var) F(Amplitude)   A((vars data,int timePeriod))                                 D({ return DF(Amplitude)  (data,timePeriod); });
C R(var) F(APO)         A((vars data,int fastPeriod,int slowPeriod,int MAType))       D({ return DF(APO)        (data,fastPeriod,slowPeriod,MAType); });
...
C R(var) F1(ATR)        A((vars open,vars high,vars low,vars close,int timePeriod))   D({ return DF1(ATR)       (open,high,low,close,timePeriod); });
C R(var) F(AvgPrice)    A(())                                                         D({ return DF(AvgPrice)   (); });
C R(var) F(BBands)      A((vars data,int timePeriod,var nbDevUp,var nbDevDn,int MAType)) D({ return DF(BBands)  (data,timePeriod,nbDevUp,nbDevDn,MAType); });
C R(var) F(Beta)        A((vars data,vars data2,int timePeriod))                      D({ return DF(Beta)       (data,data2,timePeriod); });
C R(var) F(BOP)         A(())                                                         D({ return DF(BOP)        (); });
C R(var) F(CCI)         A((int timePeriod))                                           D({ return DF(CCI)        (timePeriod); });
C R(var) F(CMO)         A((vars data,int timePeriod))                                 D({ return DF(CMO)        (data,timePeriod); });
C R(var) F(Correlation) A((vars data,vars data2,int timePeriod))                      D({ return DF(Correlation)(data,data2,timePeriod); });
C R(var) F(Covariance)  A((vars data,vars data2,int timePeriod))                      D({ return DF(Covariance) (data,data2,timePeriod); });
C R(var) F(DEMA)        A((vars data,int timePeriod))                                 D({ return DF(DEMA)       (data,timePeriod); });
C R(var) F(DX)          A((int timePeriod))                                           D({ return DF(DX)         (timePeriod); });
C R(var) F0(EMA)        A((vars data,int timePeriod))                                 D({ return DF0(EMA)       (data,timePeriod); });
C R(var) F1(EMA)        A((vars data,var alpha))                                      D({ return DF1(EMA)       (data,alpha); });
C R(var) F(HTDcPeriod)  A((vars data))                                                D({ return DF(HTDcPeriod) (data); });
C R(var) F(HTDcPhase)   A((vars data))                                                D({ return DF(HTDcPhase)  (data); });
C R(var) F(HTPhasor)    A((vars data))                                                D({ return DF(HTPhasor)   (data); });
C R(var) F(HTSine)      A((vars data))                                                D({ return DF(HTSine)     (data); });
C R(var) F(HTTrendline) A((vars data))                                                D({ return DF(HTTrendline)(data); });
C R(int) F(HTTrendMode) A((vars data))                                                D({ return DF(HTTrendMode)(data); });
C R(var) F(KAMA)        A((vars data,int timePeriod))                                 D({ return DF(KAMA)       (data,timePeriod); });
C R(var) F(LinearReg)   A((vars data,int timePeriod))                                 D({ return DF(LinearReg)(data,timePeriod); });
C R(var) F(LinearRegAngle) A((vars data,int timePeriod))                              D({ return DF(LinearRegAngle)(data,timePeriod); });
C R(var) F(LinearRegIntercept) A((vars data,int timePeriod))                          D({ return DF(LinearRegIntercept)(data,timePeriod); });
C R(var) F(LinearRegSlope) A((vars data,int timePeriod))                              D({ return DF(LinearRegSlope)(data,timePeriod); });
C R(var) F(MovingAverage) A((vars data,int timePeriod,int MAType))                    D({ return DF(MovingAverage)(data,timePeriod,MAType); });
C R(var) F(MACD)        A((vars data,int fastPeriod,int slowPeriod,int signalPeriod)) D({ return DF(MACD)       (data,fastPeriod,slowPeriod,signalPeriod); });
...
C R(var) F(MACDFix)     A((vars data,int signalPeriod))                               D({ return DF(MACDFix)    (data,signalPeriod); });
C R(var) F(MAMA)        A((vars data,var fastLimit,var slowLimit))                    D({ return DF(MAMA)       (data,fastLimit,slowLimit); });
...
C R(var) F(MaxVal)      A((vars data,int timePeriod))                                 D({ return DF(MaxVal)     (data,timePeriod); });
C R(int) F(MaxIndex)    A((vars data,int timePeriod))                                 D({ return DF(MaxIndex)   (data,timePeriod); });
C R(var) F(MedPrice)    A(())                                                         D({ return DF(MedPrice)   (); });
C R(var) F(MidPoint)    A((vars data,int timePeriod))                                 D({ return DF(MidPoint)   (data,timePeriod); });
C R(var) F(MidPrice)    A((int timePeriod))                                           D({ return DF(MidPrice)   (timePeriod); });
C R(var) F(MinVal)      A((vars data,int timePeriod))                                 D({ return DF(MinVal)     (data,timePeriod); });
C R(int) F(MinIndex)    A((vars data,int timePeriod))                                 D({ return DF(MinIndex)   (data,timePeriod); });
C R(var) F(MinMax)      A((vars data,int timePeriod))                                 D({ return DF(MinMax)     (data,timePeriod); });
C R(int) F(MinMaxIndex) A((vars data,int timePeriod))                                 D({ return DF(MinMaxIndex)(data,timePeriod); });
C R(var) F0(MinusDI)    A((int timePeriod))                                           D({ return DF0(MinusDI)   (timePeriod); });
C R(var) F1(MinusDI)    A((vars open,vars high,vars low,vars close,int timePeriod))   D({ return DF1(MinusDI)   (open,high,low,close,timePeriod); });
C R(var) F0(MinusDM)    A((int timePeriod))                                           D({ return DF0(MinusDM)   (timePeriod); });
C R(var) F1(MinusDM)    A((vars open,vars high,vars low,vars close,int timePeriod))   D({ return DF1(MinusDM)   (open,high,low,close,timePeriod); });
C R(var) F(Mom)         A((vars data,int timePeriod))                                 D({ return DF(Mom)        (data,timePeriod); });
...
C R(var) F1(PlusDI)     A((vars open,vars high,vars low,vars close,int timePeriod))   D({ return DF1(PlusDI)    (open,high,low,close,timePeriod); });
C R(var) F0(PlusDM)     A((int timePeriod))                                           D({ return DF0(PlusDM)    (timePeriod); });
C R(var) F1(PlusDM)     A((vars open,vars high,vars low,vars close,int timePeriod))   D({ return DF1(PlusDM)    (open,high,low,close,timePeriod); });
C R(var) F(PPO)         A((vars data,int fastPeriod,int slowPeriod,int MAType))       D({ return DF(PPO)        (data,fastPeriod,slowPeriod,MAType); });
C R(var) F(ROC)         A((vars data,int timePeriod))                                 D({ return DF(ROC)        (data,timePeriod); });
C R(var) F(ROCP)        A((vars data,int timePeriod))                                 D({ return DF(ROCP)       (data,timePeriod); });
C R(var) F(ROCR)        A((vars data,int timePeriod))                                 D({ return DF(ROCR)       (data,timePeriod); });
C R(var) F(ROCL)        A((vars data,int timePeriod))                                 D({ return DF(ROCL)       (data,timePeriod); });
C R(var) F(ROCR100)     A((vars data,int timePeriod))                                 D({ return DF(ROCR100)    (data,timePeriod); });
C R(var) F(RSI)         A((vars data,int timePeriod))                                 D({ return DF(RSI)        (data,timePeriod); });
C R(var) F(SMA)         A((vars data,int timePeriod))                                 D({ return DF(SMA)        (data,timePeriod); });
C R(var) F(StdDev)      A((vars data,int timePeriod))                                 D({ return DF(StdDev)     (data,timePeriod); });
...
C R(var) F(Sum)         A((vars data,int timePeriod))                                 D({ return DF(Sum)        (data,timePeriod); });
C R(var) F(T3)          A((vars data,int timePeriod,var vFactor))                     D({ return DF(T3)         (data,timePeriod,vFactor); });
C R(var) F(TEMA)        A((vars data,int timePeriod))                                 D({ return DF(TEMA)       (data,timePeriod); });
C R(var) F(TrueRange)   A(())                                                         D({ return DF(TrueRange)  (); });
C R(var) F(Trima)       A((vars data,int timePeriod))                                 D({ return DF(Trima)      (data,timePeriod); });
C R(var) F(Trix)        A((vars data,int timePeriod))                                 D({ return DF(Trix)       (data,timePeriod); });
C R(var) F(TSF)         A((vars data,int timePeriod))                                 D({ return DF(TSF)        (data,timePeriod); });
...
C R(var) F(Variance)    A((vars data,int timePeriod))                                 D({ return DF(Variance)   (data,timePeriod); });
C R(var) F(WCLPrice)    A(())                                                         D({ return DF(WCLPrice)   (); });
C R(var) F(WillR)       A((int timePeriod))                                           D({ return DF(WillR)      (timePeriod); });
C R(var) F(WMA)         A((vars data,int timePeriod))                                 D({ return DF(WMA)        (data,timePeriod); });
...
// indicators.c
C R(var) F(AC)               A((vars data))                                                    D({ return DF(AC)              (data); });
C R(var) F(ADO)              A(())                                                             D({ return DF(ADO)             (); });
C R(var) F0(AGC)             A((vars data,var alpha))                                          D({ return DF0(AGC)            (data,alpha); });
C R(var) F1(AGC)             A((vars data,int period))                                         D({ return DF1(AGC)            (data,period); });
C R(var) F0(ALMA)            A((vars data,int timePeriod,int sigma,var offset))                D({ return DF0(ALMA)           (data,timePeriod,sigma,offset); });
C R(var) F1(ALMA)            A((vars data,int timePeriod))                                     D({ return DF1(ALMA)           (data,timePeriod); });
C R(var) F(AO)               A((vars data))                                                    D({ return DF(AO)              (data); });
C R(var) F(ATRS)             A((int period))                                                   D({ return DF(ATRS)            (period); });
C R(var) F(Alligator)        A((vars data))                                                    D({ return DF(Alligator)       (data); });
C R(var) F(BBOsc)            A((vars data,int period,var nbDev,int MAType))                    D({ return DF(BBOsc)           (data,period,nbDev,MAType); });
C R(var) F(Butterworth)      A((vars data,int cutoff))                                         D({ return DF(Butterworth)     (data,cutoff); });
C R(var) F(CGOsc)            A((vars data,int period))                                         D({ return DF(CGOsc)           (data,period); });
...
C R(var) F(Coral)            A((vars data))                                                    D({ return DF(Coral)           (data); });
C R(var) F(DCOsc)            A((vars data,int period))                                         D({ return DF(DCOsc)           (data,period); });
C R(var) F(DChannel)         A((int period))                                                   D({ return DF(DChannel)        (period); });
C R(var) F(DPO)              A((vars data,int timePeriod))                                     D({ return DF(DPO)             (data,timePeriod); });
C R(var) F(Decycle)          A((vars data,int period))                                         D({ return DF(Decycle)         (data,period); });
C R(var) F(FIR3)             A((vars data))                                                    D({ return DF(FIR3)            (data); });
C R(var) F(FIR4)             A((vars data))                                                    D({ return DF(FIR4)            (data); });
C R(var) F(FIR6)             A((vars data))                                                    D({ return DF(FIR6)            (data); });
C R(var) F(Fisher)           A((vars data))                                                    D({ return DF(Fisher)          (data); });
C R(var) F(FisherInv)        A((vars data))                                                    D({ return DF(FisherInv)       (data); });
C R(var) F(FisherN)          A((vars data,int period))                                         D({ return DF(FisherN)         (data,period); });
C R(var) F(FractalDimension) A((vars data,int period))                                         D({ return DF(FractalDimension)(data,period); });
C R(var) F(FractalHigh)      A((vars data,int period))                                         D({ return DF(FractalHigh)     (data,period); });
C R(var) F(FractalLow)       A((vars data,int period))                                         D({ return DF(FractalLow)      (data,period); });
...
C R(var) F(HMA)              A((vars data,int period))                                         D({ return DF(HMA)             (data,period); });
C R(var) F(HighPass2)        A((vars data,int cutoffPeriod))                                   D({ return DF(HighPass2)       (data,cutoffPeriod); }); 
C R(var) F(Hurst)            A((vars data,int period))                                         D({ return DF(Hurst)           (data,period); });
...
C R(var) F(Keltner)          A((vars data,int timePeriod,var factor))                          D({ return DF(Keltner)         (data,timePeriod,factor); });
C R(var) F(LL)               A((int period,int offset))                                        D({ return DF(LL)              (period,offset); }); 
C R(var) F(Laguerre)         A((vars data,var alpha))                                          D({ return DF(Laguerre)        (data,alpha); });
C R(var) F(MMI)              A((vars data,int timePeriod))                                     D({ return DF(MMI)             (data,timePeriod); });
C R(var) F(Moment)           A((vars data,int period,int n))                                   D({ return DF(Moment)          (data,period,n); });
C R(var) F(Normalize)        A((vars data,int period))                                         D({ return DF(Normalize)       (data,period); });
C R(int) F(NumInRange)       A((vars low,vars high,var vMin,var vMax,int period))              D({ return DF(NumInRange)      (low,high,vMin,vMax,period); });
C R(int) F(NumRiseFall)      A((vars data,int period))                                         D({ return DF(NumRiseFall)     (data,period); });
C R(int) F(NumWhiteBlack)    A((var vBody,int offset,int period))                              D({ return DF(NumWhiteBlack)   (vBody,offset,period); });
C R(var) F(ProfitFactor)     A((vars data,int length))                                         D({ return DF(ProfitFactor)    (data,length); });
C R(var) F(RVI)              A((int period))                                                   D({ return DF(RVI)             (period); });
C R(var) F(Roof)             A((vars data,int cutOffLow,int cutOffHigh))                       D({ return DF(Roof)            (data,cutOffLow,cutOffHigh); });
C R(var) F(SAR)              A((var AFstep,var AFmin,var AFmax))                               D({ return DF(SAR)             (AFstep,AFmin,AFmax); });
C R(var) F(SIROC)            A((vars data,int timePeriod,int EMAPeriod))                       D({ return DF(SIROC)           (data,timePeriod,EMAPeriod); }); 
C R(var) F(SMom)             A((vars data,int period,int cutoff))                              D({ return DF(SMom)            (data,period,cutoff); });
C R(var) F(ShannonEntropy)   A((vars data,int length,int patternSize))                         D({ return DF(ShannonEntropy)  (data,length,patternSize); });
C R(var) F(ShannonGain)      A((vars data,int period))                                         D({ return DF(ShannonGain)     (data,period); });
C R(var) F(Smooth)           A((vars data,int cutoff))                                         D({ return DF(Smooth)          (data,cutoff); });
C R(var) F(Spearman)         A((vars data,int period))                                         D({ return DF(Spearman)        (data,period); });
C R(var) F(StochEhlers)      A((vars data,int timePeriod,int cutOffLow,int cutOffHigh))        D({ return DF(StochEhlers)     (data,timePeriod,cutOffLow,cutOffHigh); });
C R(var) F(TSI)              A((vars data,int period))                                         D({ return DF(TSI)             (data,period); });
C R(var) F(UO)               A((vars data,int cutoff))                                         D({ return DF(UO)              (data,cutoff); });
C R(var) F(Volatility)       A((vars data,int period))                                         D({ return DF(Volatility)      (data,period); });
C R(var) F(VolatilityC)      A((int timePeriod,int EMAPeriod))                                 D({ return DF(VolatilityC)     (timePeriod,EMAPeriod); });
C R(var) F(VolatilityMM)     A((vars data,int timePeriod,int EMAPeriod))                       D({ return DF(VolatilityMM)    (data,timePeriod,EMAPeriod); });
C R(var) F(ZMA)              A((vars data,int period))                                         D({ return DF(ZMA)             (data,period); });
C R(var) F(ZigZag)           A((vars data,var depth,int length,zcolor color))                  D({ return DF(ZigZag)          (data,depth,length,color); });

C R(var)   F(ccyStrength) A((char* currency))                                  D({ return DF(ccyStrength)(currency); });
C R(void)  F(ccySet)      A((var strength))                                    D({        DF(ccySet)     (strength); });
C R(void)  F(ccyReset)    A(())                                                D({        DF(ccyReset)   (); });
C R(char*) F(ccyMin)      A(())                                                D({ return DF(ccyMin)     (); });
C R(char*) F(ccyMax)      A(())                                                D({ return DF(ccyMax)     (); });
...
C R(var)   F(move)        A((vars data,int length,int movePeriod,var percent)) D({ return DF(move)       (data,length,movePeriod,percent); });
C R(var)   F(season)      A((vars data,int timePeriod,int horizon,int mode))   D({ return DF(season)     (data,timePeriod,horizon,mode); });

C R(int)   F(stridx)      A((const char* name))                                                      D({ return DF(stridx)    (name); });
C R(char*) F(strxid)      A((int index))                                                             D({ return DF(strxid)    (index); });
C R(int)   F1(dataParse)  A((int handle,const char* format,const char* fileName,int start,int num))  D({ return DF1(dataParse)(handle,format,fileName,start,num); });
C R(int)   F2(dataParse)  A((int handle,const char* format,const char* fileName,const char* filter)) D({ return DF2(dataParse)(handle,format,fileName,filter); });
