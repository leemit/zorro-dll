...
ZORRO_BUILD_EXPRESSION(bool, TradeIsClosed  , !TradeIsOpen && TradeFlag(ETradeFlag::STOPPED|ETradeFlag::PROFIT|ETradeFlag::TIME|ETradeFlag::SOLD|ETradeFlag::EXIT|ETradeFlag::REMOVED|ETradeFlag::REVERSED|ETradeFlag::EXPIRED))
...
ZORRO_BUILD_EXPRESSION(bool, TradeIsPool    , TradeIs(ETradeFlag::PHANTOM|ETradeFlag::NET))
ZORRO_BUILD_EXPRESSION(bool, TradeIsVirtual , TradeIs(ETradeFlag::PHANTOM|ETradeFlag::NET))
ZORRO_BUILD_EXPRESSION(bool, TradeIsNewBar  , g->tr->nBarClose != g->nBar)
ZORRO_BUILD_EXPRESSION(bool, TradeIsStop    , TradeIs(ETradeFlag::EVENT|ETradeFlag::STOPPED))
ZORRO_BUILD_EXPRESSION(bool, TradeIsProfit  , TradeIs(ETradeFlag::EVENT|ETradeFlag::PROFIT))
ZORRO_BUILD_EXPRESSION(bool, TradeIsEntry   , TradeIs(ETradeFlag::EVENT|ETradeFlag::WAITBUY))
ZORRO_BUILD_EXPRESSION(bool, TradeIsContract, (g->tr->nContract & EContractType::PUT|EContractType::CALL|EContractType::FUTURE) != 0)
